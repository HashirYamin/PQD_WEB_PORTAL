...
const navItems = [
  ...
  { to: '/suppliers', label: 'Supplier Profiles', icon: Truck },
  {
    to: '/master-checklist',
  ...
  useEffect(() => {
    api
      ...
      .then(({ data }) => {
        ...
        if (!selectedCompanyId && data.companies?.length === 1) {
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar-open' : ''}`}>
        <div className="brand-row">
          ...
          <div>
            ...
            <span>Submission Automation</span>
          </div>
          <button
        ...
        <div className="sidebar-footer">
          ...
          <button className="nav-item logout-button" onClick={doLogout}>
            <LogOut size={18} />
            <span>Sign out</span>
          </button>
        </div>
      ...
      <div className="main-area">
        <header className="topbar">
          ...
          <div className="topbar-title">
            <strong>PQD Workspace</strong>
            <span>
              Manage profiles, products, documents, checklists and submissions
            </span>
          </div>
